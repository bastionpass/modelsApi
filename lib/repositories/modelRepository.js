...
let ModelRepository = class ModelRepository extends internals_1.CustomRepository {
     ...
     */
    getModel(id) {
        return new internals_1.ObservableOptionalModel(this.getRawModel(id), this.modelType, this.mainRepository);
    }
    /**
...
ModelRepository = __decorate([
    internals_1.inject,
    __metadata("design:paramtypes", [typeof (_a = typeof ModelTypes !== "undefined" && ModelTypes) === "function" && _a || Object, Object, Function, internals_1.MainRepository])
], ModelRepository);
