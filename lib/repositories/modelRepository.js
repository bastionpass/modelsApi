...
let ModelRepository = class ModelRepository extends internals_1.CustomRepository {
    constructor(modelType, modelMetadata, isModel, mainRepository, asyncListProcess = 10) {
        ...
        this.loadList = (list) => {
            ...
            const fetchPromise = this.makeCancellable(this.fetchList(list.name, intermediateConsume)
                .then(mobx_1.action((rawModels) => {
     ...
     */
    createEmptyModel(id) {
        return mobx_1.observable.object(Object.assign(Object.assign({}, this.modelMetadata.emptyModel), { id, _loadState: internals_1.LoadState.none(), _modelType: this.modelType }));
    }
    /**
    ...
    consumeModels(rawModels, implList, startIndex = 0) {
        const list = implList ||
            this.getList(defaultList, false);
        ...
        if (swagger_ts_types_1.isModelWithId(rawModel)) {
            if (rawModel.metadata && rawModel.metadata.deleted) {
                ...
                if (this.hasModel(rawModel.id)) {
                    ...
                    mobx_1.set(existingModel, { _loadState: internals_1.LoadState.deleted() });
                }
     ...
     */
    clearRepository() {
        this.fetchPromises.forEach((promise) => promise.cancel());
    ...
    makeCancellable(src) {
        ...
        wrappedPromise.cancel = () => (active = false);
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array, internals_1.ModelListImpl, Number]),
    __metadata("design:returntype", void 0)
], ModelRepository.prototype, "pushModelsToList", null);
ModelRepository = __decorate([
    internals_1.inject,
    __metadata("design:paramtypes", [String, Object, Function, Object, Number])
], ModelRepository);
