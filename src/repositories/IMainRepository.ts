...
export interface IMainRepository<ModelTypes extends string> {
   ...
   */
  getModel<T extends ModelWithId> (modelType: ModelTypes, id: string)
   ...
   * @return {ObservableModel<ModelWithId | T> | UnknownModelTypeError}
   */
  getRawModel<T extends ModelWithId>(modelType: string, id: string)
   ...
   */
  denormalizeModel(model: ObservableModel < ModelWithId, ModelTypes > ,
